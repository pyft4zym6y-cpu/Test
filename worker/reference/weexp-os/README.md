...
Полный исходник методологии плагина **weexp v0.12.0-round12** (из аплоада
`weexp_round12.zip`), сохранён в репозитории как **справочник**, чтобы база не
зависела от загрузки. Плюс: `_coverage-engine.py` (движок «всё ли проверено»:
активация доменов по типу бизнеса), `lanavitta-run01/` — реальный прогон L0
(контракт находки: id/domain/as_is/to_be/gap/evidence/impact/difficulty/
funnel_step/touchpoint; coverage.json; отчёт RUN-01).
