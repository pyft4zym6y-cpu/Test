...
## 02 · Objects
Владеет: `Placement` (присутствие на площадке: карточка, рейтинг, экономика канала, правила ранжирования площадки)
Отличается от `Channel` у identity-os: канал — это факт наличия сбыта через площадку, placement — конкретное присутствие со своей экономикой и правилами.
...
## 12 · Dependencies
- **Обратные · кто зависит от нас:** `legal-os` — при изменении наших Outputs или контракта находки эти скилы обязаны быть уведомлены
- **Входящие:** pricing-os
- **Исходящие:** finance-os

## 13 · Аудит-модуль
**Модуль 13 · Площадки.** Основной слой доступа: **L0**.
Чек-лист L0: на каких площадках присутствует клиент и кто ещё торгует его товаром; качество карточек против требований площадки; рейтинг и отзывы; позиция в категории по ключевым запросам; цена против собственного сайта.
L1: право продавать бренд, ограничения производителя, авторизация.
L2: кабинет продавца, экономика канала после всех комиссий.
Выход в отчёт: профиль присутствия по каждой площадке, расчёт каннибализации собственного канала, экономика канала после комиссий.
## 14 · AI Layer
