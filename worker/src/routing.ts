...
/** Расшифровка плейбуков для клиента: что это, усилия, длительность —
 *  чтобы по scope можно было составить смету (претензия подрядчика: «что такое PB-15?»). */
export const PB_META: Record<string, { what: string; effort: string; duration: string }> = {
  'PB-15': { what: 'Разбор конверсионных страниц, гипотезы, программа A/B-тестов', effort: 'средние', duration: '4–6 нед.' },
  'PB-04': { what: 'Технические SEO-дефекты, разметка, индексация, восстановление видимости', effort: 'малые–средние', duration: '2–4 нед.' },
  'PB-05': { what: 'Пересборка таксономии каталога, фасеты, посадочные категорий', effort: 'крупные', duration: '6–10 нед.' },
  'PB-07': { what: 'Производство товарного и категорийного контента под спрос', effort: 'средние (поток)', duration: 'от 4 нед., далее поток' },
  'PB-06': { what: 'Видимость в AI-ответах: разметка, llms.txt, цитируемые пассажи', effort: 'малые', duration: '2–3 нед.' },
  'PB-10': { what: 'События GA4/dataLayer, план измерений, сквозная воронка', effort: 'средние', duration: '3–5 нед.' },
  'PB-02': { what: 'Разбор воронки по шагам на данных, карта потерь', effort: 'малые', duration: '1–2 нед. (после доступов)' },
  'PB-12': { what: 'Юнит-экономика и маржинальность до масштабирования', effort: 'малые', duration: '1–2 нед. (после выгрузок)' },
  'PB-08': { what: 'Welcome/брошенная корзина/сегменты, программа удержания', effort: 'средние', duration: '4–8 нед.' },
  'PB-13': { what: 'Ценовая лестница, промо-дисциплина, MAP-политика', effort: 'средние', duration: '3–6 нед.' },
  'PB-14': { what: 'Аудит платформы, техдолг, производительность', effort: 'средние', duration: '2–4 нед.' },
  'PB-21': { what: 'Запуск/наведение порядка на маркетплейсах', effort: 'средние', duration: '4–8 нед.' },
  'PB-37': { what: 'Позиционирование и отличие от реселлеров', effort: 'средние', duration: '3–5 нед.' },
};
