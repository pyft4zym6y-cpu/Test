...
export function buildChannels(ds: AuditDataset): ChannelsReport {
  ...
  const rows: ChannelRow[] = [
    ...
    { channel: 'Поведенческая аналитика', signal: has(/Hotjar|Clarity/) ? (has(/Hotjar/) ? 'Hotjar' : 'MS Clarity') : 'не обнаружена', status: has(/Hotjar|Clarity/) ? 'ok' : 'check', next: 'A2: карты кликов, записи, воронки', dims: ['ANL', 'UX'] },
