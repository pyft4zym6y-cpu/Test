...
const html = page('', 'Індекс пакета', `
  ...
  <table class="t" style="margin-top:4mm;font-size:8pt">
    ...
    <tr><td class="num">6</td><td>Том A · UX/UI посторінково</td><td class="num">40 стор.</td><td>кожна сторінка поблочно 0–5 + макети всіх 49 блоків «зараз/як треба»</td><td>розробник, маркетолог</td></tr>
    <tr><td class="num">7</td><td>Том B · Контент посторінково</td><td class="num">8 стор.</td><td>5 критеріїв × усі сторінки + 6 цільових текстів «зараз/як треба»</td><td>копірайтер</td></tr>
    <tr><td class="num">8</td><td>Том C · SEO і дерево сайта</td><td class="num">9 стор.</td><td>індексація ×8.6, 6 кластерів, on-page + 6 шаблонів «зараз/як треба», GEO</td><td>SEO-виконавець</td></tr>
