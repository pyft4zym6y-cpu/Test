...
export const LEVELS: Level[] = [
  ...
  },
  {
    ...
    track: 'expert',
    summary:
      'Фінальний проєкт замість теорії: бізнес-модель, аналіз ринку, стратегії продукту/ціни/маркетингу/CRM, P&L і фінмодель, IT- і data-архітектура, оргструктура, KPI tree, roadmap на 12 місяців і стратегія на 3 роки — із захистом перед «власником/інвестором».',
  },
];
...
export const TRACKS: { id: TrackId; label: string; range: string }[] = [
  ...
  { id: 'expert', label: 'Експертний блок', range: 'Рівні 13–16 · лише у Повному шляху' },
];
