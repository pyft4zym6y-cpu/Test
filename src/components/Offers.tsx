...
const MODELS = [
  ...
  },
  {
    ...
    terms: 'Початковий термін — 3 місяці, далі помісячно з відмовою за 30 днів. Передоплата на місяць; до 20% невикористаних годин переносяться далі. Щоквартальне ревʼю цінності: продовжуємо, лише якщо цифри це виправдовують.',
