...
const MODELS = [
  ...
  },
  {
    ...
    terms: 'Пілот — перші 3 місяці з фіксованими KPI першої хвилі; далі 6–12 міс. Гарантія: якщо за 6 місяців підтверджений приріст не покриває інвестицію в управління — наступні 2 місяці працюємо безкоштовно. Опційно — бонус за результат (% від приросту, фіксується в договорі).',
...
const FAQ = [
  { q: 'Скільки це коштує?', a: 'Аудит — фіксовано $2,900 або $4,900 (за оборотом). Консалтинг — $50/год з мінімумом 30 год/міс. Управління — від $3,000/міс залежно від масштабу.' },
  ...
  { q: 'Які гарантії?', a: 'DoD на кожному етапі, транші під результат. У форматі 03 — гарантія ROI: якщо за 6 місяців приріст не покрив інвестицію, 2 місяці працюємо безкоштовно.' },
];
