...
const MODELS = [
  ...
  },
  {
    ...
    terms: 'Пілот — перші 3 місяці з фіксованими KPI першої хвилі; далі 6–12 міс. Опційно — бонус за результат: % від підтвердженого приросту, фіксується в договорі.',
...
const COMPARE = [
  ...
  { k: 'Мінімальний вхід', v: ['$2,900', '$1,350/міс', '$3,000/міс'] },
  { k: 'Мінімальний термін', v: ['разово', '3 місяці', 'пілот 3 міс → 6–12 міс'] },
  { k: 'Зарахування аудиту', v: ['—', '50% у перший місяць', '100% у перший місяць'] },
];

const FAQ = [
  { q: 'Скільки це коштує?', a: 'Аудит — фіксовано $2,900 або $4,900 (за оборотом). Консалтинг — $45/год з мінімумом 30 год/міс. Управління — від $3,000/міс залежно від масштабу.' },
