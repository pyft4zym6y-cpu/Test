...
const RISKS = [
  { ifPart: 'Немає бюджету на все', then: 'Старт з аудиту за фіксовані $2,900. Швидкі перемоги за 30–60 днів фінансують наступні хвилі.', color: '#65A30D' },
            ...
            <FadeIn delay={0.35}>
              <div className="card p-7">
                ...
                <p className="text-[#5A6472] text-xs mt-5 leading-relaxed">
                  ...
                  Аудит за $2,900 виявляє мільйони упущеного обороту (приклад: ≈16,6 млн ₴) —
