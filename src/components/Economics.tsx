...
const RISKS = [
  { ifPart: 'Немає бюджету на все', then: 'Нічого страшного: старт з аудиту з фіксованою ціною, а швидкі перемоги за 30–60 днів фінансують наступні хвилі.', color: '#65A30D' },
  { ifPart: 'Немає команди', then: 'Нічого страшного: зберемо e-com відділ під ключ + підрядники — ролі, OKR, регламенти.', color: '#0F9488' },
  { ifPart: 'Немає єдиного обліку', then: 'Нічого страшного: спроєктуємо і поетапно впровадимо — без зупинки продажів.', color: '#6D28D9' },
  { ifPart: 'Своя CMS · стара платформа', then: 'Працюємо з тим, що є: підхід платформо-незалежний, міграція — лише якщо цифри її виправдовують.', color: '#B45309' },
  { ifPart: 'Виробництво не готове', then: 'Маркетплейси як швидкий вхід у ринок, паралельно готуємо DTC і бренд.', color: '#EA580C' },
  { ifPart: 'Немає аналітики', then: 'Нічого страшного: побудуємо трекінг з нуля — baseline зафіксуємо вже в перший тиждень.', color: '#65A30D' },
];
          ...
          <FadeIn delay={0.2}>
            <div className="card p-7">
              <p className="font-mono text-[0.66rem] uppercase tracking-[0.2em] text-[#4D7C0F] mb-6">
                Структура CAPEX · Кейс «Преміум-текстиль» ~$80K
              </p>
            ...
            <FadeIn delay={0.35}>
              <div className="card p-7">
                ...
                <p className="text-[#5A6472] text-xs mt-5 leading-relaxed">
                  ...
                  Аудит виявляє мільйони упущеного обороту (приклад: ≈16,6 млн ₴) —
                  інвестиція окуповується ще до старту робіт. Цифри з кейсу «Преміум-текстиль»; для вашого
