        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full px-5 sm:px-6 md:px-10 py-20">
          <FadeIn>
            ...
            <h1
              ...
              style={{ fontSize: 'clamp(2.2rem, 5.6vw, 4.4rem)', textWrap: 'balance' }}
            >
              Тепер очевидно:
              <br />
              зростання — це{' '}
          ...
          <FadeIn delay={0.15}>
            <div className="flex flex-wrap gap-4 mt-10">
              <a
                ...
                className="bg-[#A3E635] px-9 py-4 font-mono text-sm font-bold uppercase tracking-[0.12em] text-black transition-transform duration-200 hover:scale-[1.04]"
