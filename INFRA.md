...
| Ведення проєкту (кабінет + адмінка) | те саме складання | той самий проєкт Vercel · домен **app.weexp.agency** |
...
|---|---|---|
| Що віддає | маркетингові сторінки | `/cabinet`, `/admin` |
| Чужі адреси | `/cabinet`, `/admin` → 301 на app | усе інше → 301 на сайт |
