...
const CARDS = [
  ...
  { slug: 'diagnose', kick: 'Express Audit', title: 'Порахуйте, скільки виторгу витікає', metric: 'Безкоштовно · головний bottleneck + PDF' },
...
/*
 * Напрями експансії ділили одну картку хабу — те саме, що й у систем.
 *
 * Перелік мусить збігатися зі слугами EXPERTISES: коли додались брендинг,
 * UX/UI і веб-розробка, три нові сторінки лишились без власної картки й
 * показувались у стрічці як хаб. Тест expansionRoutes.test.ts стереже перелік.
 */
const EXPANSION_CARDS = [
  ...
  ['branding', 'Брендинг', 'Щоб вибирали вас, а не дешевше'],
  ['ux-ui', 'UX/UI дизайн', 'Кожен зайвий крок коштує замовлення'],
  ['web-development', 'Веб-розробка', 'Сайт має заробляти, а не вимагати уваги'],
