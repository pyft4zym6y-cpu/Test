...
const ROUTES = [
  ...
  { path: '/systems', title: `8 систем, у яких бізнес втрачає гроші${SUF}`,
    desc: 'Вісім систем онлайн-продажів — від стратегії до експансії. Веб-розробка, ERP-автоматизація, UX/UI та CRO, SEO, аналітика й вихід на ринки під одним дахом. Знайдіть, де витікає виторг.',
    content: `<h1>Де ваш бізнес втрачає гроші?</h1><p>Не сайт і не канал — уся система онлайн-продажів із восьми частин. ${esc(SERVICES)}</p>${ul(SYSTEMS)}` },
  ...
  { path: '/diagnose', title: `Business X-Ray — безкоштовний діагноз${SUF}`,
    desc: 'Пройдіть Business X-Ray за 2 хвилини: Independence Score, здоровʼя по 8 системах і головний bottleneck — без реєстрації.',
    content: `<h1>Знайдіть головний bottleneck</h1><p>Business X-Ray за 2 хвилини: оцініть 8 систем онлайн-продажів і отримайте Independence Score, Business Health і вузьке місце, що тримає прибуток — без реєстрації.</p>` },
