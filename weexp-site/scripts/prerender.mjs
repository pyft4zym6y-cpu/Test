...
const ROUTES = [
  ...
  { path: '/pricing', title: `Формати та ціни${SUF}`,
    ...
    content: `<h1>Три формати — за рівнем нашої відповідальності</h1><p>Різниця не в «пакетах послуг», а в тому, хто несе фінальну відповідальність за результат.</p>${ul(['01 Аудит — разовий проєкт, 4–6 тижнів, $2,900/$4,900: карта, де витікають гроші', '02 Консалтинг і супровід — $50/год, мін. $1,500/міс: ми архітектор і контроль, руки клієнта', '03 Управління під ключ — від $3,000/міс, 6–12 міс: проєкт ведемо ми, відповідальність наша'])}<p>Будь-яка співпраця починається з діагностики.</p>` },
];
