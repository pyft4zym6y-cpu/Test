...
for (const [slug, title, price, desc, promise, who] of FORMAT_PAGES) {
  ROUTES.push({
     ...
     */
    desc,
    content: `<h1>${esc(title)}</h1><p>${esc(promise)}</p><p><b>${esc(price)}</b></p><p>${esc(who)}</p>`
      + (slug === 'audit'
