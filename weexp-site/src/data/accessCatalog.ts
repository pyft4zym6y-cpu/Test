...
export const ACCESS_CATALOG: AccessItem[] = [
  ...
  { id: 'AC-25', system: 'Записи сесій і теплокарти (Hotjar / Clarity / PostHog)', category: 'CMS & Website', why: 'Де саме користувач застрягає — обхід цього не покаже', methods: ['view'],
  ...
  { id: 'AC-26', system: 'PIM / єдине джерело товарного контенту', category: 'CMS & Website', why: 'Один товар описаний по-різному на сайті, майданчику й у фіді', methods: ['view', 'upload'],
  ...
  { id: 'AC-27', system: 'Тестове замовлення і промокод на 100%', category: 'CX', why: 'Пройти оплату, доставку, листи й повернення, а не описати їх зі слів', methods: ['view'],
  ...
  { id: 'AC-28', system: 'Листи й повідомлення, які отримує клієнт', category: 'CX', why: 'Третина шляху клієнта живе в пошті й недоступна з сайту', methods: ['upload'],
    viewHow: `Перешліть на ${AUDIT_EMAIL} реальні листи: підтвердження, статуси доставки, прохання про відгук, реактивацію.` },
  { id: 'AC-29', system: 'Записи розмов, чати, розшифровки', category: 'CX', why: 'Голос клієнта його словами точніший за будь-яку анкету про клієнта', methods: ['upload'],
