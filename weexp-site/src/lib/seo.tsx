...
const META: Record<string, [string, string]> = {
  ...
  '/systems': [`8 систем, у яких бізнес втрачає гроші${SUFFIX}`,
    'Вісім систем онлайн-продажів — від стратегії до експансії. Веб-розробка, ERP-автоматизація, UX/UI та CRO, SEO, аналітика й вихід на ринки ЄС/США під одним дахом. Знайдіть, де витікає виторг.'],
  ...
  '/diagnose': [`Business X-Ray — безкоштовний діагноз${SUFFIX}`,
    'Пройдіть Business X-Ray за 2 хвилини: Independence Score, здоровʼя по 8 системах і головний bottleneck — без реєстрації.'],
