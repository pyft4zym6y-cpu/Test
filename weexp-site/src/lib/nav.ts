...
export const EXTRA_PAGES: PageName[] = [
  ...
  /*
   * «Експертизи» пішли з головного меню в цей перелік.
   *
   * Пункт стояв другим, одразу після «Послуг», і конкурував із ними за ту саму
   * увагу: людина, яка шукала, що саме замовити, йшла дивитись девʼять
   * напрямів робіт — тобто вбік від того, що продається. Експертиза не те, що
   * купують; купують формат. Сторінки лишились (їх знаходять пошуком), вхід на
   * них — із «Послуг» і з підвалу.
   */
