    ...
    <Block title={`База знань клієнта · ${total} записів`}>
      ...
      <div className="adm-kb-src">
        ...
        <ul className="adm-kv">
          ...
          <li><i>менеджер</i><span>передані документи й позначки з цієї картки</span></li>
        ...
        <p className="mono adm-hint">Дві сусідні сутності сюди не входять: наші методики й шаблони (однакові для всіх клієнтів) — у розділі «Аудит і проєкти → Бібліотека»; нотатки команди й C-level оцінка — на вкладці «Внутрішнє», і клієнту вони не показуються ніколи.</p>
      </div>
      {empty.length > 0 && (
