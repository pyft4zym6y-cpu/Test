...
@page{margin:16mm}*{box-sizing:border-box}body{font-family:"Golos Text","Segoe UI",system-ui,Arial,sans-serif;color:#141210;margin:0;font-size:13px;line-height:1.5}
...
h1{font-size:18px;margin:2px 0 2px}.sub{font-family:"Golos Text","Segoe UI",system-ui,sans-serif;font-size:11px;letter-spacing:.08em;text-transform:uppercase;color:#6B675E}
...
.empty{color:#9a9488;font-style:italic}.code{font-family:"Golos Text","Segoe UI",system-ui,sans-serif;font-weight:700;background:#FFF6C2;padding:3px 8px;border:1px solid #E3D9C0}
...
@page{margin:16mm}*{box-sizing:border-box}body{font-family:"Golos Text","Segoe UI",system-ui,Arial,sans-serif;color:#141210;margin:0;font-size:13px;line-height:1.55}
.bar{height:8px;background:#F5301C}.wrap{padding:26px 30px;max-width:900px}
.top{display:flex;justify-content:space-between;align-items:baseline;border-bottom:2px solid #141210;padding-bottom:12px;margin-bottom:18px}
${DOC_LOGO_CSS}.meta{font-family:"Golos Text","Segoe UI",system-ui,sans-serif;font-size:11px;color:#6B675E;text-align:right}
h1{font-size:20px;margin:2px 0 2px}.sub{font-family:"Golos Text","Segoe UI",system-ui,sans-serif;font-size:11px;letter-spacing:.08em;text-transform:uppercase;color:#6B675E}
