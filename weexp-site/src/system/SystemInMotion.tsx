  ...
  return (
    ...
    <section className="sysx sysx-hero" aria-label={t('WEEXP — ваш магазин може заробляти більше на тому самому трафіку', 'WEEXP — your store can earn more from the same traffic')}>
      <div className="sysx-hero-in">
        ...
        {/*
          * Під числами більше нічого немає.
          *
          * Стояли два посилання: «як ми рахуємо ці цифри» і тихий рядок «ще не
          * готові говорити? порахувати витік». Обидва — виходи з першого
          * екрана вбік: одне у методику, друге в калькулятор. На екрані, де
          * єдина дія — кнопка, кожне таке посилання забирає частину тих, хто
          * уже був готовий її натиснути.
          *
          * Ні те, ні те не зникло з сайту: методика лишається на /proof
          * (розділ у меню), розрахунок — тихим рядком у фінальному заклику
          * внизу сторінки, де людина його вже свідомо шукає.
          */}
      </div>
