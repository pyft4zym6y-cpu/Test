 ...
 *
 * ДЕ ВІН СТОЇТЬ — і чому вже не всюди. Блок вставлявся в оболонку, тобто на
 * КОЖНІЙ публічній сторінці, останнім перед підвалом: 167 слів, 1.2 екрана й
 * пʼять посилань геть із воронки — одразу після фінального заклику до дії.
 * Тобто в точці найвищого наміру сайт пропонував не звернутись, а почитати.
 *
 * Тепер блок живе там, де читання і є дією: на сторінках блогу. На сторінках
 * шляху до заявки останній екран лишається за однією дією.
 */
