...
export function SystemShell() {
  ...
  // Блок «Статті по темі» лишився лише в блозі — див. коментар біля рендера.
  const isBlog = base === '/blog' || base.startsWith('/blog/');
  ...
  return (
    <div className="sysh">
      ...
      {/* Блок статей — лише там, де читання і є дією. На сторінках шляху до
          заявки він стояв останнім перед підвалом і відводив із воронки
          рівно після фінального заклику. */}
      {!workspace && isBlog && <BlogTeaser />}
