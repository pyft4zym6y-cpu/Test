 ...
 *
 * Підвал ширший за меню рівно на три адреси: головну (у меню її роль виконує
 * логотип), Express audit (у шапці він кнопка, бо це дія, а не розділ) і
 * «Експертизи» (з меню пішли, щоб не конкурувати з «Послугами» за увагу того,
 * хто шукає, що замовити, — але вхід на них мусить лишитись).
 *
 * «Кабінет» звідси пішов: він живе на app.weexp.agency, і посилання в підвалі
 * сайту вело відвідувача з сайту геть.
 */
const FOOT_EXTRA = ['/', '/diagnose', '/expansion'];
const NAV = [
