 ...
 *
 * Підвал ширший за меню рівно на дві адреси: головну (у меню її роль виконує
 * логотип) і Express audit (у шапці він кнопка, бо це дія, а не розділ).
 *
 * «Кабінет» звідси пішов: він живе на app.weexp.agency, і посилання в підвалі
 * сайту вело відвідувача з сайту геть.
 */
const FOOT_EXTRA = ['/', '/diagnose'];
const NAV = [
