  ...
  return (
    <section className="sysx sysx-404" aria-label={t('Сторінку не знайдено', 'Page not found')}>
      <div className="sysx-404-in">
        ...
        <h1 className="sysx-display sysx-404-h">{t('Такої сторінки немає —', 'This page does not exist —')}{' '}<br className="br-wide" />{t('але ', 'but the ')}<span className="sysx-em">{t('система', 'system')}</span>{t(' на місці.', ' is in place.')}</h1>
